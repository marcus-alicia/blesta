...
Configure::set('generic_server.map', [
    ...
    'module_row_meta' => [
        ...
        (object) ['key' => 'package_field_label_1', 'value' => 'IP Address', 'serialized' => 0, 'encrypted' => 0],
        (object) ['key' => 'package_field_name_1', 'value' => 'sharedip', 'serialized' => 0, 'encrypted' => 0],
        ...
        (object) ['key' => 'package_field_values_1', 'value' => (object) ['module' => 'sharedip'], 'serialized' => 0, 'encrypted' => 0],

        (object) ['key' => 'package_field_label_2', 'value' => 'Accounts Limit', 'serialized' => 0, 'encrypted' => 0],
        (object) ['key' => 'package_field_name_2', 'value' => 'domains_quota', 'serialized' => 0, 'encrypted' => 0],
        ...
        (object) ['key' => 'package_field_values_2', 'value' => (object) ['module' => 'domains_quota'], 'serialized' => 0, 'encrypted' => 0],
