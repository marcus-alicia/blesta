...
Configure::set('opensrs.map', [
    ...
    'module_row_meta' => [
        (object) ['key' => 'name', 'value' => (object) ['module' => 'plugin_opensrs_plugin_name'], 'serialized' => 0, 'encrypted' => 0],
        ...
        (object) ['key' => 'package_field_values_0', 'value' => (object) ['module' => 'plugin_opensrs_username'], 'serialized' => 0, 'encrypted' => 0],
        ...
        (object) ['key' => 'package_field_values_1', 'value' => (object) ['module' => 'plugin_opensrs_private_key'], 'serialized' => 0, 'encrypted' => 0],
