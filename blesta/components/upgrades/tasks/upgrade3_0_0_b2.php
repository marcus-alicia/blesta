 ...
 */
class Upgrade3_0_0B2 extends UpgradeUtil
{
     ...
     */
    private function addAustralianStates($undo = false)
    {
        if ($undo) {
            // Nothing to undo
            return;
        ...
        $this->Record->query(
            "INSERT INTO `states` (`country_alpha2`, `code`, `name`)
                VALUES ('AU', 'ACT', 'Australian Capital Territory'), ('AU', 'NT', 'Northern Territory');"
        );
    }
}
