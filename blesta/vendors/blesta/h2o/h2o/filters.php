...
class HtmlFilters extends FilterCollection
{
    ...
    protected static function htmlAttribute($attrs = [], $data = [])
    {
    ...
    protected static function extract($attrs = [], $data = [])
    {
        $result = [];
...
h2o::addFilter(['md5', 'sha1', 'numberformat' => 'number_format', 'wordwrap', 'trim', 'upper' => 'strtoupper', 'lower' => 'strtolower']);

/* Add filter collections */
h2o::addFilter(['CoreFilters', 'StringFilters', 'NumberFilters', 'DatetimeFilters', 'HtmlFilters']);

/* Alias default to set_default */
h2o::addFilter('default', ['CoreFilters', 'set_default']);
